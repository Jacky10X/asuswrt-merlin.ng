...
code += '<option value="0" '+ (variable.smart_connect_x === '0' ? 'selected': '') +'><#4072#>';
code += '<option value="1" '+ (variable.smart_connect_x !== '0' ? 'selected': '') +'><#4071#>';
code += '</select>'
...
function() {
variable.location_code = 'AA'; // I just change the CN to AA. Don't know how to get the original location code of router
apply('reboot');
return true;
}
);
